...
<li>AWS</li>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-xl-5 col-md-6">
                                    <div class="resume-item wow fadeInUp delay-0-2s">
                                        ...
                                        <div class="content">
                                            <span class="years">January 2026 – June 2026</span>
                                            <h4>Full-Stack Developer (Laravel/PHP)</h4>
                                            <span class="company">Eziline Software House Pvt Ltd</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 col-md-6">
                                    <div class="resume-item wow fadeInUp delay-0-3s">
                                        ...
                                        <div class="content">
                                            <span class="years">July 2025 – October 2025</span>
                                            <h4>Full-Stack Developer (Laravel/PHP)</h4>
                                            <span class="company">Exarth ATD</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 col-md-6">
                                    <div class="resume-item wow fadeInUp delay-0-4s">
                                        ...
                                        <div class="content">
                                            <span class="years">June 2024 – September 2024</span>
                                ...
                                <div class="col-xl-5 col-md-6">
                                    <div class="resume-item wow fadeInUp delay-0-2s">
                                        ...
                                        <div class="content">
                                            <span class="years">February 2023 – July 2023</span>
                                            <h4>Web Developer Intern</h4>
                                            <span class="company">Ezitech Solution</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 col-md-6">
   ...
   <div class="contact-form contact-form-wrap form-style-one wow fadeInUp delay-0-4s">
    <form id="contactForm" name="contactForm" 
          action="https://formsubmit.co/ammarmalik046@gmail.com" method="POST">
        <input type="hidden" name="_captcha" value="false">
        <input type="hidden" name="_next" value="https://ammarweb.vercel.app/contact">
        <div class="row">
            <!-- Full Name -->
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="phone_number" name="phone_number" class="form-control"
                           placeholder="+923345865096" required>
